...
<body>
   ...
   <!--Ordenador-->
   <!--Logo-->
   <div class="md:flex md:items-center md:gap-0  ">
    <img class="w-20 h-27" src="../assets/imagenes/logo.png" alt="Logo de la ONG">
    <h1 class="text-xl font-bold font-serif">Latido del lince</h1>
    </div>

    <!--Navegador-->
    <ul class=" md:flex  md:items-center md:gap-10 :font-serif  hover:text-emerald-700 ">
    ...
    <!--Registro y login-->
    <div class="md:flex md:items-center md:gap-8  md:mr-20">
        <button class= "border-2 border-[#1a4d2e] px-3 py-3 rounded-lg text-emerald-700  transition-transform hover:bg-[#1a4d2e] hover:text-white   "><a href="login.php">Iniciar Sesión</a></button>
        <button class="border-2 px-3 py-3 rounded-lg  border-[#D2691E] bg-[#D2691E] text-white hover:opacity-85" ><a href="registro.php"> Registrarse ♥</a></button>
    </div>
   </header>
</body>
</html>