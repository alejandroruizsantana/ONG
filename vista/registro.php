<?php // Página de registro. Formulario para crear una nueva cuenta de usuario.
session_start();
// Iniciamos sesión para poder manejar posibles mensajes y redirecciones.
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
    <!-- Página de registro: cuenta nueva con datos y validación -->
