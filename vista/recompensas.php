    ...
    <section class="py-24 px-4 bg-[#f8f7f4] border-t border-gray-100">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <!-- Bronce -->
                <div class="p-8 rounded-3xl shadow-sm text-center transition-transform duration-300 hover:scale-105 <?php echo $bronce_completado ? 'bg-emerald-50 border-emerald-300 shadow-md' : 'bg-white border border-yellow-200'; ?>">
                ...
                <!-- Plata -->
                <div class="p-8 rounded-3xl shadow-sm text-center transition-transform duration-300 hover:scale-105 <?php echo $plata_completado ? 'bg-emerald-50 border-emerald-300 shadow-md' : 'bg-white border border-yellow-200'; ?>">
