        ...
        <form action="../Controlador/controlador_donacion.php" method="POST" class="space-y-8">
            ...
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                ...
                <?php if (isset($_SESSION['usuario'])): ?>
                    <!-- Si el Usuario esta autenticado: mensaje de bienvenida y datos ocultos -->
                ...
                <?php else: ?>
                    <!-- Si no esta autenticado: formulario de nombre y email -->
                    ...
                    <!-- Enlace a login para acumular puntos -->
            ...
            <div class="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <!-- Opción: Tarjeta  -->
                    <label class="flex items-center justify-between p-4 border-2 bg-amber-50/10 rounded-xl cursor-pointer hover:border-amber-500 transition-colors">
