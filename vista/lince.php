<?php
// página informativa sobre el lince ibérico
include '../partes/header.php';
?>

<main class="flex-grow pt-20">

    <!-- sección hero: introducción y título principal -->
    ...
    <!-- sección de biología: descripción general de la especie e imagen -->
    ...
    <!-- sección de amenazas: impacto de la basura en el hábitat del lince -->
    <section class="bg-[#f8f7f4] py-20 px-4">
        <div class="max-w-6xl mx-auto">
            ...
            <!-- tres tarjetas con los principales tipos de amenaza -->
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                
                <!-- tarjeta: ingestión de plásticos -->
                ...
                <!-- tarjeta: contaminación del agua -->
                <div class="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all group">
                    <div class="w-14 h-14 bg-red-50 rounded-2xl flex items-center justify-center text-red-500 text-2xl mb-8 group-hover:scale-110 transition-transform">
                ...
                <!-- tarjeta: degradación del hábitat -->
                <div class="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all group">
                    <div class="w-14 h-14 bg-red-50 rounded-2xl flex items-center justify-center text-red-500 text-2xl mb-8 group-hover:scale-110 transition-transform">
    ...
    <!-- sección de acciones: qué hace la ong para proteger al lince -->
    <section class="py-20 px-4 bg-white">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="space-y-12 mb-16">
                ...
                <!-- acción 3: restauración del hábitat -->
                <div class="flex items-start gap-6">
                    <div class="w-14 h-14 bg-white/10 rounded-2xl flex-shrink-0 flex items-center justify-center text-[#D2691E] text-2xl shadow-inner">
            ...
            <!-- imagen de restauración de hábitat -->
