...
<div id="mobile-menu" 
    ...
    <div class="flex flex-col">
        <div class="flex items-center justify-between p-4 border-b border-gray-100">
            ...
            <!-- CORRECCIÓN: Añadida la X para cerrar -->
        ...
        <?php if (isset($_SESSION['usuario'])): ?>
            <a href="../vista/perfil_usuario.php" class="flex items-center gap-4 mb-4 p-2 bg-gray-50 rounded-xl">
                <div class="w-12 h-12 rounded-full border-2 border-[#D2691E] overflow-hidden">
                    <img src="../assets/imagenes/avatar_default.png" alt="Perfil" class="w-full h-full object-cover">
                </div>
        ...
        <?php if (isset($_SESSION['usuario'])): ?>
            <div class="hidden md:flex items-center gap-4">
                ...
                <a href="../Controlador/controlador_logout.php" 
                   class="flex items-center gap-2 px-3 py-2 text-gray-500 hover:text-red-700 hover:bg-red-50 rounded-lg transition-all duration-300 group" 
                   title="Cerrar Sesión">
            ...
            </div> <!-- CORRECCIÓN: Faltaba cerrar este div -->
        <?php else: ?>
            <div class="hidden md:flex items-center gap-2">
                <a href="../vista/login.php" class="border-2 border-[#1a4d2e] px-4 py-2 rounded-lg text-sm font-semibold hover:bg-[#1a4d2e] hover:text-white transition duration-500">Iniciar Sesión</a>
                <a href="../vista/registro.php" class="bg-[#D2691E] px-4 py-2 rounded-lg text-white text-sm font-semibold hover:opacity-90 transition">Registrarse</a>
            </div>
        <?php endif; ?>
